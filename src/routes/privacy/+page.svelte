...
<Jumbotron title="Privacy Policy" currentPage="Privacy Policy" />

<Container>
	<h1 class=" mb-4 font-bold">Privacy Policy</h1>
	<p class=" mb-4">Last updated: February 24, 2025</p>
	<p class=" mb-2">
	...
	<h2 class=" my-4 font-semibold">Interpretation and Definitions</h2>
	<h3 class=" my-3 font-semibold">Interpretation</h3>
	<p class=" mb-2">
		The words of which the initial letter is capitalized have meanings defined under the following
		conditions. The following definitions shall have the same meaning regardless of whether they
		appear in singular or in plural.
	</p>
	<h3 class=" my-3 font-semibold">Definitions</h3>
	...
	<ul class=" list-disc">
		...
		<li class="ml-4">
			<p class=" mb-2">
				...
				or &quot;Our&quot; in this Agreement) refers to Open Data Uganda, Plot 29-37 Ntinda Road, Kampala.
			</p>
		</li>
		<li class="ml-4">
			<p class=" mb-2">
		...
		<li class="ml-4">
			<p class=" mb-2"><strong>Country</strong> refers to: Uganda</p>
		</li>
		<li class="ml-4">
			<p class=" mb-2">
		...
		<li class="ml-4">
			<p class=" mb-2"><strong>Service</strong> refers to the Website.</p>
		</li>
		<li class="ml-4">
			<p class=" mb-2">
		...
		<li class="ml-4">
			<p class=" mb-2">
				<strong>Website</strong> refers to Open Data Uganda, accessible from
				<a
					class=" italic underline"
					href="https://opendataug.org"
					rel="external nofollow noopener"
					target="_blank">https://opendataug.org</a
				>
			</p>
		</li>
		<li class="ml-4">
	...
	<h2 class=" my-4 font-semibold">Collecting and Using Your Personal Data</h2>
	<h3 class=" my-3 font-semibold">Types of Data Collected</h3>
	<h4 class=" my-2 font-semibold">Personal Data</h4>
	<p class=" mb-2">
	...
	<ul class=" list-disc">
		...
		<li class="ml-4">
			<p class=" mb-2">First name and last name</p>
		</li>
		<li class="ml-4">
			<p class=" mb-2">Usage Data</p>
		</li>
	</ul>
	<h4 class=" my-2 font-semibold">Usage Data</h4>
	...
	<h4 class=" my-2 font-semibold">Tracking Technologies and Cookies</h4>
	<p class=" mb-2">
	...
	<h3 class=" my-3 font-semibold">Use of Your Personal Data</h3>
	...
	<h3 class=" my-3 font-semibold">Retention of Your Personal Data</h3>
	<p class=" mb-2">
	...
	<h3 class=" my-3 font-semibold">Transfer of Your Personal Data</h3>
	<p class=" mb-2">
	...
	<h3 class=" my-3 font-semibold">Delete Your Personal Data</h3>
	<p class=" mb-2">
	...
	<h3 class=" my-3 font-semibold">Disclosure of Your Personal Data</h3>
	<h4 class=" my-2 font-semibold">Business Transactions</h4>
	<p class=" mb-2">
		If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be
		transferred. We will provide notice before Your Personal Data is transferred and becomes subject
		to a different Privacy Policy.
	</p>
	<h4 class=" my-2 font-semibold">Law enforcement</h4>
	<p class=" mb-2">
		Under certain circumstances, the Company may be required to disclose Your Personal Data if
		required to do so by law or in response to valid requests by public authorities (e.g. a court or
		a government agency).
	</p>
	<h4 class=" my-2 font-semibold">Other legal requirements</h4>
	<p class=" mb-2">
		The Company may disclose Your Personal Data in the good faith belief that such action is
		necessary to:
	</p>
	<ul class=" list-disc">
		<li class="ml-4">Comply with a legal obligation</li>
		<li class="ml-4">Protect and defend the rights or property of the Company</li>
		<li class="ml-4">Prevent or investigate possible wrongdoing in connection with the Service</li>
		<li class="ml-4">Protect the personal safety of Users of the Service or the public</li>
		<li class="ml-4">Protect against legal liability</li>
	</ul>
	<h3 class=" my-3 font-semibold">Security of Your Personal Data</h3>
	<p class=" mb-2">
	...
	<h2 class=" my-4 font-semibold">Children's Privacy</h2>
	<p class=" mb-2">
	...
	<h2 class=" my-4 font-semibold">Links to Other Websites</h2>
	<p class=" mb-2">
	...
	<h2 class=" my-4 font-semibold">Changes to this Privacy Policy</h2>
	<p class=" mb-2">
